...
<section class="hero">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5">
                    ...
                    <a href="#" class="btn green l-find-out">Find out more</a>
                </div>
                <div class="col-md-7">
    ...
    <div class="bottom">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <p>All of the quality, none of the hassle.</p>
                </div>
            </div>
        </div>
    </div>
...
<section id="find-out" class="partners">
    <div class="container">
        <div class="row">
            <div class="col-md-3">
...
<section class="training-programs bg-2">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="title center"><b class="purple">Training programs</b></div>
            </div>
        </div>
        <div class="row item">
            <div class="col-md-6">
            ...
            <div class="col-md-12">
                <div class="flexslider testimonials-slider">
                    <ul class="slides">
                        <li class="slide">
                            <div class="quote">
                                “Strive Training just get on with it. I can trust them to deliver quality training to my staff that’s 100% relevant to our own needs, with minimal interruption. Absolute professionals.”
                            </div>
                            <p class="author">Kylie Milun, Manager, River Care</p>
                        </li>
                        <li class="slide">
                            <div class="quote">
                                “From day one, the Strive team were so supportive and made the entire process so smooth and painless. I couldn’t have asked for anything more.”
                            </div>
                            <p class="author">Leonie Richardson, Care Assistant, Bartley Green</p>
                        </li>
                         <li class="slide">
                            <div class="quote">
                                “Strive Training just get on with it. I can trust them to deliver quality training to my staff that’s 100% relevant to our own needs, with minimal interruption. Absolute professionals.”
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5">
                ...
                <a href="index.php" class="btn green">View blog</a>
            </div>
            <div class="col-md-7 posts">
                   <div class="box">
                    ...
                    <div class="inner-text">
                       ...
                       <a href="single.php" class="btn green">Read more</a>
                </div>
                <div class="box">
